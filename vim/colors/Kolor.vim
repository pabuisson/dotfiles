...
if g:kolor_bold==0
  ...
  highlight Search          guifg=#ff8901    guibg=NONE       gui=underline
  ...
  highlight Search          guifg=#ff8901    guibg=NONE       gui=bold,underline
...
if &t_Co > 255
  ...
  if g:kolor_bold==0
    ...
    highlight Search          ctermfg=208     ctermbg=none    cterm=underline
    ...
    highlight Search          ctermfg=208     ctermbg=none    cterm=bold,underline
