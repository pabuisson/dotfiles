...
" Search : removed the green highlight during the search, and set the results in yellow
" (but let the underline all the same) to be easier to spot
"hi IncSearch ctermfg=16 ctermbg=107 cterm=NONE guifg=#182227 guibg=#8bb664 gui=NONE
"hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi IncSearch ctermfg=16 ctermbg=107 cterm=NONE guifg=#18227 guibg=#F2EE66 gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=#F2EE66 guibg=NONE gui=underline
...
" Set the todo background color to yellow, so that they are easier to spot in
" one glance
"hi Todo ctermfg=247 ctermbg=NONE cterm=inverse,bold guifg=#9a9a9a guibg=NONE gui=inverse,bold,italic
hi Todo ctermfg=247 ctermbg=NONE cterm=inverse,bold guifg=#F2EE66 guibg=NONE gui=inverse,bold,italic
