...
# SUBCOMMANDS AND SINGLE QUOTES
# When defining an alias with subcommands, always use single quotes! Otherwise, what's
# inside subcommands get evaluated everytime (even when initializing the shell and reading
# those aliases, which throws errors 'not in a git repo' for instance).
