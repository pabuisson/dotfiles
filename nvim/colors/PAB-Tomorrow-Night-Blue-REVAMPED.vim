...
let s:folded      = "b8bfd1"
let s:background  = "29333f"
let s:selection   = "003f8e"
let s:line        = "26374c"
let s:comment     = "707ea0"
let s:red         = "ff9da4"
let s:orange      = "ffc58f"
let s:yellow      = "ffea99"
let s:green       = "d1f1a9"
...
let g:colors_name = "PAB-Tomorrow-Night-Blue-REVAMPED"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("FoldColumn", s:folded, s:background, "")
  if version >= 700
  ...
  call <SID>X("Todo",       s:yellow, s:background, "bold")
